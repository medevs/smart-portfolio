      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid grid-cols-2 gap-6 mt-12 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
          <div className="flex flex-col items-center justify-center space-y-2">
            <CodepenIcon className="w-10 h-10 text-blue-500" />
            <span className="text-sm font-medium">React</span>
          </div>
          <div className="flex flex-col items-center justify-center space-y-2">
            <CodepenIcon className="w-10 h-10 text-gray-900 dark:text-gray-50" />
            <span className="text-sm font-medium">Next.js</span>
          </div>
          <div className="flex flex-col items-center justify-center space-y-2">
            <WindIcon className="w-10 h-10 text-cyan-500" />
          ...
          <div className="flex flex-col items-center justify-center space-y-2">
            <CodepenIcon className="w-10 h-10 text-green-500" />
            <span className="text-sm font-medium">Node.js</span>
          </div>
          <div className="flex flex-col items-center justify-center space-y-2">
            <GitGraphIcon className="w-10 h-10 text-orange-500" />
            <span className="text-sm font-medium">Git</span>
          </div>
          <div className="flex flex-col items-center justify-center space-y-2">
            <BellIcon className="w-10 h-10 text-black dark:text-white" />
            <span className="text-sm font-medium">Vercel</span>
          </div>
          <div className="flex flex-col items-center justify-center space-y-2">
            <PaletteIcon className="w-10 h-10 text-blue-600" />
